# ********** Mon programme d'entraînement du discriminateur Electra ***********
# ********** sur l'ensemble de données GoEmotions de Google   *********** 
# Dernière date de mise à jour: 25 Septembre 2024 
...
# Controler le comportement de l'allocateur de mise ne cache: 31 Mai 2024
os.environ["PYTORCH_CUDA_ALLOC_CONF"] = "expandable_segments:True"

# importation des autres libraries
...
# My data path
dataset_path = "/home/MesProgsPython/data/full_dataset/"
...
# Vider la mémoire inoccupée par le cache
...
print("Le nombre de GPUs = ", torch.cuda.device_count())
print("Les GPUs visibles = ", torch.cuda.is_available())
...
experiments_dir = "/home/MesProjets2024/experiments/"
...
print("Le chemin du meilleur model checkpoint est : ",best_model_path) 

# **********
# trainer.checkpoint_callback.best_model_path

# **********
#best_model_path =/home/MesProjets2024/experiments/lightning_logs/version_20/checkpoints/epoch=2-step=886-val_loss=2.71.ckpt"

#"/home/MesProjets2024/experiments/lightning_logs/version_21/checkpoints/epoch=2-step=1086-val_loss=1.53.ckpt"
#best_model_path
